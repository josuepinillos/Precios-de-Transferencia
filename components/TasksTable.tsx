...
export const TasksTable = () => {
  ...
  return (
    <div className="glass rounded-2xl border border-[#1e253c] flex flex-col h-full overflow-hidden">
      {/* Table Header */}
      <div className="hidden xl:grid grid-cols-[auto_2.5fr_1.5fr_1fr_1fr_1fr_1.5fr_1fr_auto] gap-4 px-6 py-4 border-b border-[#1e253c] text-[10px] font-bold text-slate-400 tracking-wider uppercase items-center">
        ...
        {tasks.map((task) => {
          ...
          return (
            <motion.div 
              ...
              className={clsx(
                "grid grid-cols-[auto_1fr_auto] xl:grid-cols-[auto_2.5fr_1.5fr_1fr_1fr_1fr_1.5fr_1fr_auto] gap-3 xl:gap-4 px-3 sm:px-4 py-3 rounded-xl items-center cursor-pointer transition-colors border",
            ...
            >
              ...
              {/* Empresa */}
              <div className="hidden xl:block text-xs text-slate-400 truncate">{task.empresa}</div>

              {/* Fecha Límite */}
              <div className="hidden xl:block text-xs text-slate-300">{task.dueDate}</div>
              ...
              {/* Progreso */}
              <div className="col-span-3 xl:col-span-1 flex items-center gap-3 xl:pr-4">
              ...
              {/* Acciones */}
              <div className="hidden xl:flex justify-center w-8">
      ...
      {/* Pagination Footer */}
      <div className="px-4 sm:px-6 py-4 border-t border-[#1e253c] flex flex-col sm:flex-row gap-3 sm:justify-between sm:items-center bg-[#0b0f19]/50">
